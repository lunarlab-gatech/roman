...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', required=True, help='Path to input ROS2 bag folder')
    parser.add_argument('--output', required=True, help='Path to output ROS2 bag folder')
